...
const Editar_usuario = ({mostrarEditar, usuario}) =>{
    ...
    return(
            <div className="h-full py-12 bg-gray-700 bg-opacity-50 flex justify-center items-center transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
