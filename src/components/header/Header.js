...
const curriculum = [
  {
    name: 'Alta idiomas',
    description: 'Alta de idiomas, donde podrás añadir idiomas a la base de datos.',
    href: '/21/alta_i',
    icon: FlagIcon,
  },
]
              ...
              <Popover className="relative">
                {({ open }) => (
                  <>
                    ...
                    >
                      <DocumentChartBarIcon className="h-6 w-6 flex-shrink-0 text-sky-600" aria-hidden="true" />
