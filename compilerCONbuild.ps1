...
Copy-Item "D:\Todo\Programas\Xampp\htdocs\Ejercicios\TFG-Bolsa-de-Trabajo\repo-github\BolsaTrabajo\src\bash" -Destination "D:\Todo\Programas\Xampp\htdocs\21\bash" -Recurse;
